  ...
  <header class="border-b border-slate-800 bg-[#111827] px-4 py-3 lg:px-5">
    <div class="flex items-center gap-3">
      ...
      >
        ...
        <kbd class="ml-auto hidden rounded border border-slate-600 px-1.5 py-0.5 text-xs text-slate-500 md:inline-block">⌘K</kbd>
      </button>

      <div class="ml-auto flex items-center gap-2">
        <button class="rounded-lg p-2 text-slate-300 hover:bg-slate-800" title="上传任务" type="button">⇪</button>
        <button class="rounded-lg p-2 text-slate-300 hover:bg-slate-800" title="音乐" type="button">♫</button>
        <button class="rounded-lg p-2 text-slate-300 hover:bg-slate-800" title="通知" type="button">◌</button>
